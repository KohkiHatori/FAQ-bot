...
graph TB
    ...
    %% Business Logic to Data Layer connections
    FAQ --> DB
    VECTOR --> FAISS
    VECTOR --> CACHE
    PENDING --> CACHE
    ...
    class API,ROUTES,AUTH api
    class FAQ,VECTOR,CLAUDE,PENDING business
    class DB,FAISS,CACHE data
    class AWS,HF external
```
